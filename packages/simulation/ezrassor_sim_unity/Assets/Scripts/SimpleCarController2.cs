...
public class SimpleCarController2 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        Rover = GameObject.Find("ezrassor2");
    ...
    public void FixedUpdate()
    {
        ...
        wheelSpeed = ScriptHolder.GetComponent<WheelSubRassor2>().linearInfo;
        roverRotation = ScriptHolder.GetComponent<WheelSubRassor2>().angularInfo;
