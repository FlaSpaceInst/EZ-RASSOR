...
public class SimpleCarController1 : MonoBehaviour {
    public List<AxleInfo1> axleInfos; 
    ...
    void Start()
    {
        ...
        Rover = GameObject.Find("ezrassor1");
    ...
    public void FixedUpdate()
    {
        ...
        wheelSpeed = ScriptHolder.GetComponent<WheelSubRassor1>().linearInfo;
        roverRotation = ScriptHolder.GetComponent<WheelSubRassor1>().angularInfo;;
        ...
        foreach (AxleInfo1 axleInfo in axleInfos) {
