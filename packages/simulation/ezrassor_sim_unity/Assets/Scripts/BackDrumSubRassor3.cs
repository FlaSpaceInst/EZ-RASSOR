...
public class BackDrumSubRassor3 : MonoBehaviour
{
    float drumMsg;
    ...
    void Start()
    {
        ...
        ez = GameObject.Find("ezrassor3");
        // create subsriber instance
        ROSConnection.instance.Subscribe<backDrum>("/ezrassor3/back_drum_instructions", drumMove);
    }
