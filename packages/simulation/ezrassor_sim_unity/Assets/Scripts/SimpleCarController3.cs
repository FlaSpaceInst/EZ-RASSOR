...
public class SimpleCarController3 : MonoBehaviour {
    public List<AxleInfo3> axleInfos; 
    ...
    void Start()
    {
        ...
        Rover = GameObject.Find("ezrassor3");
    ...
    public void FixedUpdate()
    {
        ...
        wheelSpeed = ScriptHolder.GetComponent<WheelSubRassor3>().linearInfo;
        roverRotation = ScriptHolder.GetComponent<WheelSubRassor3>().angularInfo;
        ...
        foreach (AxleInfo3 axleInfo in axleInfos) {
