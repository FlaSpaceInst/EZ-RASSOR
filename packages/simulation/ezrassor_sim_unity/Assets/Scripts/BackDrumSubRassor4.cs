...
public class BackDrumSubRassor4 : MonoBehaviour
{
    float drumMsg;
    ...
    void Start()
    {
        ...
        ez = GameObject.Find("ezrassor4");
        // create subscriber instance
        ROSConnection.instance.Subscribe<backDrum>("/ezrassor1/back_drum_instructions", drumMove);
    }
