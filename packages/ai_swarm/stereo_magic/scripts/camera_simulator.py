...
class CameraSim:
  ...
  def __init__(self):
    ...
    self.left = cv2.imread(GLOBAL_PATH +  '/src/stereo_magic/sample_images/left.png',0)
    self.right = cv2.imread(GLOBAL_PATH + '/src/stereo_magic/sample_images/right.png',0)
