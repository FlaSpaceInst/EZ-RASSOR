...
class Rectify:
  ...
  def __init__(self):
    ...
    self.ret = [np.load(GLOBAL_PATH + '/src/stereo_magic/params/ret.npy')]
    self.rvecs = np.load(GLOBAL_PATH + '/src/stereo_magic/params/rvecs.npy')
    self.tvecs = np.load(GLOBAL_PATH + '/src/stereo_magic/params/tvecs.npy')
