...
def on_start_up (
    ...
    try:
        ...
        move_it = MoveIt(robot, scene, move_group, paver_arm_claw_instructions_topic)

        # MultiArray Format: [x, y, z, flag]
        # flag: 1.0 = pickup, 2.0 = place, 3.0 = manual
        # Plan to substitute with custom message when time permits
        rospy.Subscriber(paver_arm_controller_instructions_topic, Float64MultiArray, move_it.HandleCommand)
        rospy.spin()
