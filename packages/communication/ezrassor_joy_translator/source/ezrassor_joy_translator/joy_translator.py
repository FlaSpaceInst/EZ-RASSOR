...
def start_node():
    try:
        ...
        publish_topic_wheels = rospy.get_param(
            rospy.get_name() + "/wheel_instructions_topic"
        )
        publish_topic_front_arm = rospy.get_param(
            rospy.get_name() + "/front_arm_instructions_topic"
        )
        publish_topic_back_arm = rospy.get_param(
            rospy.get_name() + "/back_arm_instructions_topic"
        )
        publish_topic_front_drum = rospy.get_param(
            rospy.get_name() + "/front_drum_instructions_topic"
        )
        publish_topic_back_drum = rospy.get_param(
